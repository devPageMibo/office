...
//             {
//                 data: data,
//                 backgroundColor: ['#006FF4', '#FF8C00', '#00A979', '#ff0044'],
//                 borderColor: ['#006FF499', '#FF8C0044', '#00A97944', '#ff0044'],
//                 borderWidth: 1,
//             },
//         ],
//     };
...
export const ChartsDoughnut = ({ ...customerData }) => {
    // Check if customerData.assets exists
    if (!customerData.assets) {
        // Handle the case where assets is undefined or null
        return null;
    }
